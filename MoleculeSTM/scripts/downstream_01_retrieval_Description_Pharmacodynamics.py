...
if __name__ == "__main__":
    ...
    print("********** Evaluation for Molecule-Text Retrieval (Description & Pharmacodynamics) **********")
    ...
    parser.add_argument("--dataspace_path", type=str, default=os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "data"))
    ...
    ########## for MegaMolBART ##########
    parser.add_argument("--vocab_path", type=str, default="/workspace/MoleculeSTM/MoleculeSTM/bart_vocab.txt")
