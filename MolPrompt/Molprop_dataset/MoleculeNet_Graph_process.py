...
def tokenizer_prompt(prompt_text):
    _SCIBERT_PATH = os.environ.get(
        'SCIBERT_PATH',
        '/home/cheriearjun/data/pretrained_SciBERT/models--allenai--scibert_scivocab_uncased/snapshots/24f92d32b1bfb0bcaf9ab193ff3ad01e87732fc1'
    )
    tokenizer = BertTokenizer.from_pretrained(_SCIBERT_PATH)
