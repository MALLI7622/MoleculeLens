...
ax.annotate(
    ...
    fontsize=12.0, arrowprops=dict(arrowstyle="->", lw=0.8, color="#333333"),
    color="#333333"
)
ax.annotate(
    ...
    fontsize=12.0, arrowprops=dict(arrowstyle="->", lw=0.8, color=RICH_COL),
    color=RICH_COL
)
ax.set_xticks(shown_layers); ax.set_xticklabels(shown_layer_labels, rotation=0, fontsize=15.0)
ax.set_xlim(-0.4, 12.4)
ax.tick_params(axis="y", labelsize=15.0)
ax.set_xlabel("RoBERTa layer", fontsize=17.0); ax.set_ylabel("Recall@1", fontsize=17.0)
ax.set_title("(A) Layer-emergence curve", fontsize=17.0, fontweight="bold")
ax.legend(fontsize=15.0, frameon=False)
...
ax.set_xlim(-0.4, 12.4)
ax.tick_params(axis="y", labelsize=15.0)
ax.set_xlabel("RoBERTa layer", fontsize=17.0)
ax.set_ylabel(r"R@1 gap (rich $-$ nodrug)", fontsize=17.0)
ax.set_title("(B) Leakage gap per layer\n(red = gap > 0.03)", fontsize=17.0, fontweight="bold")
ax.legend(fontsize=15.0, frameon=False)
...
ax.set_xlim(-0.4, 12.4)
ax.tick_params(axis="y", labelsize=15.0)
ax.set_xlabel("RoBERTa layer", fontsize=17.0); ax.set_ylabel("MRR", fontsize=17.0)
ax.set_title("(C) MRR vs RoBERTa depth", fontsize=17.0, fontweight="bold")
ax.legend(fontsize=15.0, frameon=False)
